...
var snakeGame;
var delay = 100;
var secondKeyAvailable = true;
var highScore = 0;

window.onload = function()
	{
		snakeGame = new SnakeGame(900, 600, 30, delay);
...
document.onkeydown = function handleKeyDown(e)
	{
		...
		switch(key)
		{
			...
			case 32:
				snake = new Snake([[6,4],[5,4],[4,4],[3,4],[2,4]], "right");
				apple = new Apple([10,10]);
				snakeGame.init(snake, apple, delay);
				return;
				break;
			default:
				return;
...
function SnakeGame(canvasWidth, canvasHeight, blockSize)
{
		...
		this.gameOver = function()
		{
			...
			this.ctx.strokeText("Game Over", centerX, centerY -150);
			this.ctx.fillText("Game Over", centerX, centerY -150);
			
			this.ctx.font = "bold 30px sans-serif";
			this.ctx.strokeText("Appuyer sur la touche ESPACE pour rejouer", centerX, centerY -100);
			this.ctx.fillText("Appuyer sur la touche ESPACE pour rejouer", centerX, centerY -100);
			this.ctx.restore();
		}
		...
		this.drawScore = function()
		{
			...
			this.ctx.fillText("Best:", 12, this.canvas.height -13);
			this.ctx.fillText(highScore.toString(), 65, this.canvas.height -13);
			this.ctx.restore();
		}
